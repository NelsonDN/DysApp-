"""
Django settings for dyslexia_project project.
...
SECRET_KEY = 'django-insecure-cerjdmf#a@6ut^$#pkv#%dz0dgz8uj2!_97#a$qy@#u71_xi1m'
...
INSTALLED_APPS = [
    ...
    'dyslexia_project.apps.MonAppConfig',
